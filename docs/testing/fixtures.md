...
- One instance of each supported service — Radarr, Sonarr, Chaptarr, SABnzbd, qBittorrent, NZBGet, Transmission, Tautulli, and Jellyfin (a throwaway container with two empty libraries is enough) — plus a second instance of at least one arr for the admin exploratory session.
