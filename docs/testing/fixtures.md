...
- One instance of each supported service — Radarr, Sonarr, Chaptarr, Lidarr, SABnzbd, qBittorrent, NZBGet, Transmission, Tautulli, Jellyfin, and Emby (a throwaway container of each with two empty libraries is enough) — plus a second instance of at least one arr for the admin exploratory session.
