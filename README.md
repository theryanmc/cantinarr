...
8. Sharing a media server? Open **Watch on Plex** / **Watch on Jellyfin** / **Watch on Emby** in the menu: create your account or sign in with one you already have (Jellyfin, Emby), or sign in with Plex or share your Plex email and accept the invite (Plex), then sign in at the address shown
