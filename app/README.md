...
- **Season cards count the whole season** -- "11/13 Episodes Available • 2 unaired" rather than Sonarr's aired-and-monitored fraction, which calls a season with episodes still to come 100% complete. The remainder is named (**missing** for aired episodes Sonarr is hunting, **unaired**/**unmonitored** for the rest) and green is reserved for a season that is genuinely all on disk.
